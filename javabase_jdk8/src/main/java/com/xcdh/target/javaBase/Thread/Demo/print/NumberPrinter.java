package com.xcdh.target.javaBase.Thread.Demo.print;
...
public class NumberPrinter {
    ...
    public void test() throws InterruptedException {
        ...
        //打印线程A
        Thread threadA=new Thread(new Printer(reentrantLock,conditionA, conditionB),"A");
        //打印线程B
        Thread threadB=new Thread(new Printer(reentrantLock, conditionB, conditionC),"B");
        //打印线程C
        Thread threadC=new Thread(new Printer(reentrantLock, conditionC, conditionA),"C");
        // 依次开启a b c线程
        threadA.start();
        Thread.sleep(100);
        threadB.start();
