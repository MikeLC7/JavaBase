package com.xcdh.target.javaBase.DataStructure.Array.arithmetic.QuickSort;
 ...
 * @author: MikeLC
 *
 * @date: 2018/11/2 下午 10:14
 *
 * Copyright ( c ) 2018
 *
 */
public class QuickOptimizeSort {
    ...
    private static int partitionIt(int[] array,int left,int right){
        ...
        //
        System.out.print("基数："+array[j]+"：基数位置："+j+":");
        for(int is : array){
            System.out.print(is+" ");
        }
        System.out.println();
    ...
    public void demo1(){
        int i = 0;
        int pivot = 10;// pivot 为选取的基准元素（头元素）
        while(true){
            while(i<20 && ++i < pivot){
